...
type AccessCode = 'nightBefore' | 'weddingDay'
...
function App() {
  ...
  const PinScreen = () => {
    ...
    return (
      <div className="bg-beige min-h-screen flex flex-col items-center gap-6 px-5 text-center">
        ...
        <Input
          ...
          className="bg-white max-w-[240px] text-center"
        />

        {error && (
          <p className="text-red-600 text-sm font-adega">{error}</p>
        )}
        ...
        !access ? (
          ...
          <><div className="flex flex-col text-forest-green items-center text-center justify-center gap-10 text-lg b-beige py-10">
            ...
            <Button
              ...
              onClick={() => rsvpRef.current?.scrollIntoView({
                behavior: "smooth",
                block: "start",
              })}
            >
          ...
          </div><div className="flex flex-col items-center justify-center text-center py-12 bg-beige" ref={rsvpRef}>
