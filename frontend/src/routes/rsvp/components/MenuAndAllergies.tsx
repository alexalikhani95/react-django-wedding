...
export const MenuAndAllergies = ({
  ...
  return (
    <div>
      <div
        className={`grid grid-cols-1 ${hideMealChoices ? "" : "sm:grid-cols-2"} py-15 px-10 bg-cover bg-center bg-no-repeat ${
          nightBeforeAccess
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="font-evafiya text-xl">
                  To reflect our values, our wedding menu is entirely
                  plant-based
                </p>
              </div>
