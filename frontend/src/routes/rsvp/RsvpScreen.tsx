            ...
            <div className="flex justify-center">
              ...
              >
                ...
                <div className="text-center">
                  <p className="text-5xl font-mattedly leading-tight">
                    The Menu
                  </p>
                </div>
                ...
                <section className="flex flex-col gap-2 mt-3">
                  <h2 className="text-4xl font-mattedly mb-1">
                    The Main Event
                  </h2>
                    ...
                    render={({ field }) => (
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <span className="text-xl">
                            Butternut squash, spinach & mushroom en croûte,
                            roast tomato sauce, tenderstem broccoli, fondant
                            potato
                          </span>
                        </Label>
                    ...
                    render={({ field }) => (
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <span className="text-xl">
                            Chocolate tart, passion fruit sorbet, chocolate
                            sauce, passion fruit crumb
                          </span>
                        </Label>
                        ...
                        >
                          ...
                          />
                          <span className="text-xl">
                            Elderflower jelly, summer fruits, vegan crème
                            fraîche
                          </span>
                        </Label>
                      </RadioGroup>
