      ...
      <div className="flex flex-col p-4 max-w-md mx-auto">
        ...
        <form onSubmit={onSubmit} className="mb-6 bg-white rounded-lg border p-4 shadow-sm">
          ...
          <div className="flex gap-2">
            <Input {...register("name", { required: true })} placeholder="Table name" className="flex-1" disabled />
  ...
  return (
    <div className="flex flex-col p-4 max-w-md mx-auto">
      ...
      <form onSubmit={onSubmit} className="mb-6 bg-white rounded-lg border p-4 shadow-sm">
        <h2 className="text-sm font-semibold mb-3">Add Table</h2>
        <div className="flex gap-2">
          <Input {...register("name", { required: true })} placeholder="Table name" className="flex-1" />
        ...
        <div className="mb-6 bg-white rounded-lg border p-4 shadow-sm">
          ...
          {selectedGuest && (
            <div className="mt-3 p-2 bg-blue-50 rounded text-sm flex items-center justify-between">
              ...
              <button onClick={() => setSelectedGuest(null)} className="text-blue-600 hover:text-blue-800">
                <X className="w-4 h-4" />
              </button>
            </div>
          )}
              ...
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  className={`m-2 transition-colors duration-200 ${
                    isConfirmingTableDelete ? "bg-orange-500 hover:bg-orange-600" : ""
                  }`}
                  onClick={(e) => {
                    e.stopPropagation()
                ...
                <div className="p-4 border-t bg-gray-50">
                  ...
                  <div className="flex items-stretch gap-2">
                    ...
                    <div className="flex-1 flex flex-col gap-2">
                      <div className="grid grid-cols-4 gap-1">{topSeats.map(renderSeat)}</div>

                      <div className="bg-yellow-700 rounded-lg py-4 px-3">
                        <p className="text-white text-center font-semibold text-sm">{table.name}</p>
                      </div>

                      <div className="grid grid-cols-4 gap-1">{bottomSeats.map(renderSeat)}</div>
                    </div>
